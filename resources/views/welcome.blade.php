                ...
                <div class="col-lg-10 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <img class="img-responsive img-full" src="/img/aq13.jpg" width="450" height="295" alt="cesta frutta e verdura"> 
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="/img/aq14.jpg" width="450" height="300" alt="verdura di stagione"> 
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="/img/aq15.jpg" width="450" height="299" alt="asparagi e cavolfiore"> 
                            </div>                            
                        </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <img class="img-responsive img-border img-left" src="/img/aq18.jpg" width="450" height="299" alt="grano"> 
                    <hr class="visible-xs">
